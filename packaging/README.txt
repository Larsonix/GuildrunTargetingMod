...
SCORES AND LEADERBOARDS
  ...
  A run played with the mod on cannot submit a score and does not
  move your Red Rift win streak in either direction.
...
On a Red Rift run played with the mod on, a win does not advance the
streak and a loss or abandon does not reset it.
...
Already have an older version of the mod ? Do the same three steps and
say yes to replacing files. Nothing to uninstall, nothing is left
behind, and your settings and progress are kept. If the game is open,
restart it. If you still have MelonLoader from last time, the smaller
mod-only zip is enough on its own.
